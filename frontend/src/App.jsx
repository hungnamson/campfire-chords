  ...
  return (
    <div className="min-h-screen bg-[#fcfbfa] text-stone-900 font-sans pb-20 md:pb-0 flex flex-col">
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <header className="bg-[#f5f3ef]/90 backdrop-blur sticky top-0 z-30 border-b border-[#e3ded5] shadow-sm transition-all duration-300 w-full flex flex-col">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-900/60 backdrop-blur-sm p-4 animate-fade-in" onClick={() => setShowVersionTracker(false)}>
          <div className="bg-white border border-stone-200 rounded-2xl max-w-lg w-full max-h-[80vh] overflow-y-auto shadow-2xl p-6 relative select-none flex flex-col no-scrollbar" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col gap-6 overflow-y-auto pr-1 no-scrollbar">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow pb-2">
                  ...
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    ...
                    <li>Khử cache di động: Khuyên dùng tải lại trang cứng (Hard Reload) hoặc cửa sổ ẩn danh để xóa sạch mã JS cũ còn lưu trong bộ nhớ đệm trình duyệt điện thoại.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.13.5</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-450 tracking-widest">14/06/2026 (Đêm)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi trắng màn hình khi tìm kiếm & Tích hợp chọn bài ngay trong trình xem</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Sửa lỗi trắng màn hình: Khắc phục lỗi crash khi nhập tìm kiếm do truy cập thuộc tính `chordPro` của các bài hát không có hợp âm (null/undefined).</li>
                    <li>Tìm & chọn bài tại chỗ: Nút tìm kiếm trong màn hình xem bài hát giờ hiển thị trực tiếp thanh tìm kiếm bài hát và danh sách gợi ý dạng dropdown nổi để chọn nhanh bài hát mới mà không cần thoát.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.13.4</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">14/06/2026 (Tối muộn)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi Click Tìm kiếm trên Máy tính & Phân định chức năng nút Tìm kiếm</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Sửa lỗi click Máy tính: Gỡ bỏ thuộc tính `select-none` khỏi thanh tiêu đề (Header) chính, khắc phục hoàn toàn lỗi chặn nhấp chuột và không nhận tiêu điểm trên thanh tìm kiếm của màn hình máy tính (Desktop).</li>
                    <li>Điều hướng Tìm kiếm bài hát: Nút tìm kiếm trong phòng xem bài hát (cả giao diện điện thoại và máy tính) giờ được cấu hình chuyên dụng để quay trở lại Thư viện và tự động đưa con trỏ vào ô tìm kiếm bài hát mới, thay vì tìm kiếm lời nhạc tại chỗ.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.13.3</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">14/06/2026 (Tối)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Tích hợp thanh tìm kiếm vào Header & Tự động xoá khi chọn</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Tích hợp Header: Hộp tìm kiếm lời nhạc tại chỗ hiện được tích hợp thẳng vào thanh tiêu đề (Header) của cả điện thoại và máy tính, đảm bảo 100% không bị che khuất bởi z-index và dễ dàng chạm/kích hoạt lập tức.</li>
                    <li>Tự động xoá nội dung: Tự động xoá sạch từ khoá tìm kiếm cũ mỗi khi người dùng nhấp vào thanh tìm kiếm hoặc mở biểu tượng tìm kiếm, sẵn sàng để gõ nội dung mới ngay lập tức.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.13.2</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow pb-2">
                  ...
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    ...
                    <li>Nút bấm nhạy bén: Sửa lỗi cướp tiêu điểm (focus) do sự kiện touchstart gây ra, giúp tất cả các nút điều khiển nhịp điệu, tốc độ, cài đặt pedal hoạt động phản hồi lập tức và nhạy bén hơn.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.13.0</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">14/06/2026 (Sáng)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Cập nhật Bộ Sưu Tập Drumbeats M4A Chất Lượng Cao</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Nhạc đệm chất lượng cao: Thay thế toàn bộ các tệp trống bằng 14 bản thu điệu trống định dạng `.m4a` chất lượng cao.</li>
                    <li>Đồng bộ hóa nhịp độ: Cập nhật cấu hình nhịp điệu `DRUM_STYLES` để liên kết chính xác nhịp BPM gốc từ tên tệp tin thực tế, giúp duy trì tốc độ và tính toán tỉ lệ phát lại chính xác tuyệt đối.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.11</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">14/06/2026 (Sáng)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Duy trì kết nối Pedal sau khi sử dụng Tap Tempo</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Khôi phục tiêu điểm: Tự động chuyển tiêu điểm (focus) ngược lại vùng thu phím ẩn (keycatcher textarea) ngay sau khi chạm vào nút dò nhịp Tap Tempo. Điều này ngăn chặn việc mất liên kết phím và giúp các thiết bị bàn đạp Bluetooth tiếp tục hoạt động bình thường.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.10</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow pb-2">
                  ...
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    ...
                    <li>Bộ dò tốc độ Tap Tempo: Biến nút BPM thành bộ phát hiện nhịp gõ (Tap Tempo detector). Khi chạm liên tiếp vào nút này, ứng dụng sẽ tự động tính toán khoảng thời gian giữa các lần chạm để thiết lập tốc độ (BPM) tương ứng cho nhịp điệu trống.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.8</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Đêm)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Chuyển cấu hình Bàn đạp Pedal vào Menu Cài đặt bài viết</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Dọn dẹp giao diện: Loại bỏ hoàn toàn các biểu tượng bàn phím (Keyboard Icon) chuyên dụng trên thanh công cụ và phím nổi overlay để tránh gây rối mắt.</li>
                    <li>Menu Cài đặt mới: Tích hợp tùy chọn cấu hình "Bàn Đạp Pedal" trực tiếp vào bên trong danh sách tùy chọn của nút Menu (Ba chấm dọc ở Mobile / biểu tượng Chia sẻ ở Desktop Toolbar).</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.7</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Tối)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Hiển thị giá trị Tốc độ BPM trực quan trên SongViewer</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Hiển thị BPM: Tích hợp trực tiếp chỉ số tốc độ hiện tại (BPM) vào bên cạnh tên điệu nhạc trên cả thanh tiêu đề Mobile (Mobile Header) và thanh điều khiển Desktop (Desktop Footer). Thay đổi tốc độ sẽ cập nhật giá trị trực quan ngay lập tức.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.6</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều muộn)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi phím tắt không hoạt động khi đang mở Modal Cài đặt</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Khắc phục Bộ lọc Keydown: Loại trừ phần tử keycatcher ẩn (textarea) khỏi điều kiện chặn sớm (early return check) của trình xử lý keydown toàn cục. Nhờ đó, ngay khi phím vừa được ánh xạ thành công trong cài đặt (chế độ ghi nhận tắt), người dùng nhấn phím sẽ ngay lập tức kích hoạt tính năng tương ứng mà không bị bộ lọc thẻ nhập liệu bỏ qua.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.5</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Duy trì keycatcher textarea toàn phần ngoài modal</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Kích hoạt Keycatcher Toàn diện: Chuyển vùng nhập ẩn (textarea) ra cấp ngoài cùng của khung hiển thị bài hát để luôn giữ phần tử này trên DOM. Tự động chuyển tiếp tiêu điểm (focus) vào vùng này khi đóng modal và khi người dùng nhấp chạm các vị trí trống trên bảng hợp âm, đảm bảo bàn đạp pedal Bluetooth hoạt động ổn định và liên tục trong mọi khoảnh khắc.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.4</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Hỗ trợ cử chỉ 2 ngón tay (Multi-Touch) trên iPad</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Cử chỉ tương tác điệu trống: Vuốt 2 ngón tay Lên/Xuống để chuyển đổi điệu trống tiếp theo/trước đó. Vuốt 2 ngón tay Sang Trái/Phải để điều chỉnh tăng/giảm tốc độ nhịp điệu (Tempo +/- 5 BPM). Có thông báo (Toast) hiển thị trực tiếp.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.3</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Đồng bộ hóa Focus cử chỉ người dùng khi thoát cài đặt</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Kích hoạt Focus Đồng thì: Chuyển toàn bộ các nút thoát (Hoàn tất, nút X, nhấp ngoài màn hình) sang gọi hàm đóng đồng bộ handleClosePedalConfig để chuyển tiếp tiêu điểm (focus) vào vùng hiển thị bài hát ngay trong chuỗi sự kiện tương tác của người dùng, giải quyết triệt để quy định bảo mật của iOS Safari vốn từ chối chuyển focus không bắt nguồn từ cử chỉ trực tiếp.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.2</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Duy trì sự kiện bàn phím phần cứng trên iOS Safari</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Kích hoạt Focus vùng chứa: Gán thuộc tính tabIndex={0} cho toàn bộ khung hiển thị bài hát và tự động kích hoạt tiêu điểm (focus) khi bài hát tải xong hoặc đóng cài đặt để đảm bảo trình duyệt Safari liên tục chuyển tiếp dữ liệu phím từ bàn đạp tới ứng dụng.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.1</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi nuốt tín hiệu phím khi mở xem bài hát</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Dọn dẹp và giới hạn Focus: Tự động xóa tiêu điểm (blur) ô tìm kiếm của trang chủ khi mở xem bài hát để trình duyệt nhận tín hiệu phím ngay lập tức, đồng thời chỉ chặn phím điều hướng khi tiêu điểm nằm ở ô nhập liệu thuộc vùng hiển thị bài hát.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.12.0</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Tích hợp hướng dẫn sửa lỗi kẹt phím trợ năng của iPadOS</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Chỉ dẫn Trợ năng trực quan: Thêm khung cảnh báo và hướng dẫn xử lý trực tiếp trong bảng gán phím (khi dùng iPad) để người dùng tắt tính năng "Truy cập bàn phím toàn phần" (Full Keyboard Access) của iPadOS vốn chặn toàn bộ tín hiệu phím Mũi tên từ các thiết bị ngoài gửi tới trình duyệt.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.9</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Trưa)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Ép phát sự kiện phím điều hướng trên Safari/iPadOS</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Đặt vị trí con trỏ thông minh: Tự động điền chuỗi khoảng trống và đặt con trỏ soạn thảo vào giữa (vị trí 1) khi nhấp Map, buộc trình duyệt Safari phải phát sự kiện phím di chuyển cursor thay vì bỏ qua sự kiện điều hướng khi thẻ rỗng.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.8</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi gán phím Mũi tên (Trái / Phải) trên iPad Safari</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Thẻ textarea bắt phím: Sử dụng thẻ textarea ẩn thay vì thẻ div/input để tiếp nhận tiêu điểm gán phím, giúp iPadOS Safari chuyển giao phím Mũi tên Trái/Phải (chế độ 2 của JOYO JSP-01) trực tiếp cho ứng dụng thay vì tự động di chuyển hoặc cuộn trang.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.7</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.5</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Cải tiến cơ chế nhận diện phím gán trên iPad/iOS Safari</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Định vị thẻ nhập ngoài màn hình: Định vị thẻ nhập ẩn sang toạ độ âm ngoài màn hình thay vì tắt pointer-events, giúp trình duyệt Safari của iPadOS cho phép focus và truyền sự kiện phím chuẩn xác.</li>
                    <li>Làm sạch focus nút: Tự động huỷ focus của nút Map ngay khi click để tránh sự kiện phím bị nuốt bởi cơ chế trợ năng mặc định của nút trên hệ điều hành iOS.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.4</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.2</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Sửa lỗi gán phím & Sao chép mã cấu hình trên iPad/Safari</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Sửa lỗi nút Map trên iPad: Loại bỏ sự kiện chạm touch-start xung đột gây hiện tượng nhấp nháy liên tục không nhận phím gán trên iOS/iPadOS Safari.</li>
                    <li>Thêm ô sao chép dự phòng: Tự động hiển thị mã cấu hình Base64 trong ô nhập liệu cho phép chọn tất cả và sao chép thủ công nếu trình duyệt chặn quyền clipboard API.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.1</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Đồng bộ cấu hình Pedal giữa các thiết bị (Sync Mappings across Devices)</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Đồng bộ đa thiết bị: Thêm tính năng Sao chép mã cấu hình (Export) trên Mac/PC và Nhập mã cấu hình (Import) trên iPad/Điện thoại để đồng bộ nhanh chóng cấu hình gán phím Pedal.</li>
                    <li>Sửa lỗi lưu trữ: Đảm bảo cài đặt bàn đạp Pedal được đồng bộ tức thì mà không cần cài đặt lại thủ công trên từng trình duyệt khác nhau.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.11.0</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Chiều)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Cấu hình Bàn đạp Bluetooth (Pedal Mapping Utility)</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Tích hợp Bàn đạp Pedal: Cho phép gán các nút nhấn trên Pedal Bluetooth vào 9 chức năng (Cuộn trang, Đổi tông, Chuyển điệu trống, Chỉnh tốc độ trống, Bật/Tắt nhịp đệm).</li>
                    <li>Lưu cấu hình tự động: Lưu các nút phím gán trực tiếp vào LocalStorage, tự động kích hoạt mỗi khi mở ứng dụng.</li>
                    <li>Hỗ trợ đa nền tảng: Cung cấp giao diện cấu hình trực quan trên cả thanh công cụ Desktop và thanh điều khiển Mobile.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.10.0</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Trưa)</span>
                  <p className="text-xs font-bold text-stone-800 mt-1">Cải tiến Chất lượng Ghi âm (256 kbps High-Fidelity Audio)</p>
                  <ul className="list-disc list-inside text-[11px] text-stone-600 mt-2 space-y-1 pl-1">
                    <li>Nâng cấp chất lượng thu âm: Tăng bitrate mã hóa lên 256 kbps giúp âm thanh rõ nét, hạn chế tối đa nhiễu nén.</li>
                    <li>Sửa lỗi phát lại trên iOS/Safari: Tự động phát hiện thiết bị và chuyển sang định dạng audio/mp4 (AAC) tương thích gốc với iPhone/iPad.</li>
                    <li>Đồng bộ hóa giao diện di động: Đồng bộ widget ghi âm mượt mà cho cả hai giao diện máy tính và điện thoại.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-stone-100 border border-stone-200 text-stone-755 tracking-wider font-mono">v1.9.0</span>
                  <div className="w-[1.5px] bg-stone-200 flex-grow mt-2"></div>
                </div>
                <div className="flex-grow pb-2">
                  <span className="text-[10px] font-black uppercase text-stone-400 tracking-widest">13/06/2026 (Sáng)</span>
