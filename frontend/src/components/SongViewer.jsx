...
export default function SongViewer({ 
  ...
  const [DRUM_STYLES, setDrumStyles] = useState([
    { name: 'Boléro', bpm: 83, audioFile: 'Rumba 83.m4a', originalBpm: 83 },
    { name: 'Slow', bpm: 65, audioFile: 'slowrock 65.m4a', originalBpm: 65 },
    { name: 'Slow Rock', bpm: 65, audioFile: 'slowrock 65.m4a', originalBpm: 65 },
    { name: 'Slow Surf', bpm: 60, audioFile: 'Slow Surf 60.m4a', originalBpm: 60 },
    { name: 'Blues', bpm: 60, audioFile: 'Ballade 60.m4a', originalBpm: 60 },
    { name: 'Ballad', bpm: 60, audioFile: 'Ballade 60.m4a', originalBpm: 60 },
    { name: 'Chachacha', bpm: 130, audioFile: 'Chachacha 130.m4a', originalBpm: 130 },
    { name: 'Disco', bpm: 120, audioFile: 'Disco 120.m4a', originalBpm: 120 },
    { name: 'Rhumba', bpm: 83, audioFile: 'Rumba 83.m4a', originalBpm: 83 },
    { name: 'Tango', bpm: 120, audioFile: 'Tango 120.m4a', originalBpm: 120 },
    { name: 'Boston', bpm: 60, audioFile: 'Boston 60.m4a', originalBpm: 60 },
    { name: 'Fox', bpm: 120, audioFile: 'Disco 120.m4a', originalBpm: 120 },
    { name: 'Rock', bpm: 110, audioFile: 'Pop 110.m4a', originalBpm: 110 },
    { name: 'Valse', bpm: 120, audioFile: 'Valse 120.m4a', originalBpm: 120 },
    { name: 'Bossa Nova', bpm: 110, audioFile: 'Bossa Nova 110.m4a', originalBpm: 110 },
    { name: 'Pop', bpm: 110, audioFile: 'Pop 110.m4a', originalBpm: 110 },
    { name: 'Habanera', bpm: 75, audioFile: 'Habarena 75.m4a', originalBpm: 75 },
    { name: 'Twist', bpm: 120, audioFile: 'Disco 120.m4a', originalBpm: 120 },
    { name: 'March', bpm: 160, audioFile: 'March 160.m4a', originalBpm: 160 },
    { name: 'Pasodoble', bpm: 120, audioFile: 'Tango 120.m4a', originalBpm: 120 },
    { name: 'Slow Ballad', bpm: 60, audioFile: 'Ballade 60.m4a', originalBpm: 60 },
    { name: 'Rap', bpm: 110, audioFile: 'Pop 110.m4a', originalBpm: 110 },
    { name: 'Samba', bpm: 120, audioFile: 'Samba 120.m4a', originalBpm: 120 },
    { name: 'Pop Ballad', bpm: 60, audioFile: 'Ballade 60.m4a', originalBpm: 60 },
    { name: 'Rock Ballad', bpm: 60, audioFile: 'Ballade 60.m4a', originalBpm: 60 }
  ]);
