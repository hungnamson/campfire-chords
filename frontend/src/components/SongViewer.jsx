...
export default function SongViewer({ 
  ...
  const [DRUM_STYLES, setDrumStyles] = useState([
    { name: 'Boléro', bpm: 80, audioFile: 'Bolero_80bpm_BEST_LOOP.wav', originalBpm: 80 },
    { name: 'Slow', bpm: 65, audioFile: 'Slow_65_LOOP_4bars.wav', originalBpm: 65 },
    { name: 'Slow Rock', bpm: 60, audioFile: 'Slowrock_60_LOOP_4bars.wav', originalBpm: 60 },
    { name: 'Slow Surf', bpm: 70, audioFile: 'Slow_Surf_70_LOOP_4bars.wav', originalBpm: 70 },
    { name: 'Blues', bpm: 65, audioFile: 'Ballad_65bpm_BEST_LOOP.wav', originalBpm: 65 },
    { name: 'Ballad', bpm: 65, audioFile: 'Ballad_65bpm_BEST_LOOP.wav', originalBpm: 65 },
    { name: 'Chachacha', bpm: 80, audioFile: 'Chachacha_80bpm_BEST_LOOP.wav', originalBpm: 80 },
    { name: 'Disco', bpm: 120, audioFile: 'Disco_120bpm_BEST_LOOP.wav', originalBpm: 120 },
    { name: 'Rhumba', bpm: 82, audioFile: 'Rumba_82_LOOP_4bars.wav', originalBpm: 82 },
    { name: 'Tango', bpm: 110, audioFile: 'Tango_110_LOOP_4bars.wav', originalBpm: 110 },
    { name: 'Boston', bpm: 60, audioFile: 'Boston_60_LOOP_4bars.wav', originalBpm: 60 },
    { name: 'Fox', bpm: 120, audioFile: 'Disco_120bpm_BEST_LOOP.wav', originalBpm: 120 },
    { name: 'Rock', bpm: 160, audioFile: 'Rock_160_LOOP_4bars.wav', originalBpm: 160 },
    { name: 'Valse', bpm: 80, audioFile: 'Waltz_80bpm_BEST_LOOP.wav', originalBpm: 80 },
    { name: 'Bossa Nova', bpm: 93, audioFile: 'Bosa_Nova_93_LOOP_4bars.wav', originalBpm: 93 },
    { name: 'Pop', bpm: 110, audioFile: 'Pop_110_LOOP_4bars.wav', originalBpm: 110 },
    { name: 'Habanera', bpm: 74, audioFile: 'Habarena_74_LOOP_4bars.wav', originalBpm: 74 },
    { name: 'Twist', bpm: 130, audioFile: 'Twist_130_LOOP_4bars.wav', originalBpm: 130 },
    { name: 'March', bpm: 160, audioFile: 'March_160_LOOP_4bars.wav', originalBpm: 160 },
    { name: 'Pasodoble', bpm: 120, audioFile: 'paso_doble_120_LOOP_4bars.wav', originalBpm: 120 },
    { name: 'Slow Ballad', bpm: 65, audioFile: 'Ballad_65bpm_BEST_LOOP.wav', originalBpm: 65 },
    { name: 'Rap', bpm: 92, audioFile: 'Rap_92_LOOP_4bars.wav', originalBpm: 92 },
    { name: 'Samba', bpm: 120, audioFile: 'Samba_120_LOOP_4bars.wav', originalBpm: 120 },
    { name: 'Pop Ballad', bpm: 65, audioFile: 'Ballad_65bpm_BEST_LOOP.wav', originalBpm: 65 },
    { name: 'Rock Ballad', bpm: 65, audioFile: 'Ballad_65bpm_BEST_LOOP.wav', originalBpm: 65 }
  ]);
